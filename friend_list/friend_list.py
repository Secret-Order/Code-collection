...
class SKE:
    ...
    def operate(self, friend_table, nickname_table, id_table):
        print("1. Group")
        print("2. Person")
        choice_1 = int(input("Enter choice: "))
        if choice_1 == 1:
            self.group_members(friend_table, nickname_table)
        elif choice_1 == 2:
            ...
            if choice_2 == 1:
                ...
                self.display_members(friend_table, self.find_index(nickname_table, nickname))
            elif choice_2 == 2:
                id_student = [input("Enter ID: ")]
                self.display_members(friend_table, self.find_index(id_table, id_student))
